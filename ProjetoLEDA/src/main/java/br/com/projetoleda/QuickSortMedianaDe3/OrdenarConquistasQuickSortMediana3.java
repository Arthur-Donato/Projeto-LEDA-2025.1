...
public class OrdenarConquistasQuickSortMediana3 {
    ...
    public static int particaoPivotQuickSort(CSVRecord[] lista, int primeiroIndice, int ultimoIndice){
        ...
        double pivotValor = Double.parseDouble(lista[posicaoPivot].get(26));
        ...
        while(i <= j){
            ...
            try{
                numeroPosicaoI = Double.parseDouble(lista[i].get(26));
            }catch(NullPointerException e){
                numeroPosicaoI = 0;
            }

            try{
                numeroPosicaoJ = Double.parseDouble(lista[i].get(26));
            }catch(NullPointerException e){
                numeroPosicaoJ = 0;
            }
    ...
    public static int medianaDe3(CSVRecord[] lista, int primeiroIndice, int indiceMeio, int ultimoIndice){
        Double valorPrimeiroIndice = Double.parseDouble(lista[primeiroIndice].get(26));
        Double valorIndiceMeio = Double.parseDouble(lista[indiceMeio].get(26));
        Double valorUltimoIndice = Double.parseDouble(lista[ultimoIndice].get(26));
